...
cases_malaysia, cases_state, interest_rates, ridership_headline, vax_malaysia, vax_district, vax_demog_age, population_district, malaysia_district_geojson = None, None, None, None, None, None, None, None, None
...
projections = {
    ...
    'cases_state': {'_id': 0, 'date': 1, 'state': 1, 'cases_new': 1, 'cases_unvax': 1, 'cases_fvax': 1},
...
def split_query(collection_name, projection, num_splits=5):
